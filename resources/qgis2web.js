...
map.getView().fit([8383981.245649, 1153963.460282, 8664507.867408, 1295872.820235], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">BHARATHAPUZHA WEB GIS</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (104 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This webgis shows the major spatial datas of Bharathapuzha River basin for the planning and development.';
            }
